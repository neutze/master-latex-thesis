...
Similar to the Google Play Server, the store application has the knowledge of whether the user has purchased the application and thus is allowed to execute it or not.
As soon as the user logged in once with the Appstore application the information is on the device.
