...
com/google/android/vending/licensing/LicenseValidator
LicenseValidator, responsible for decrypting and verifying the response from the licensing server\cite{developersLicensingReference}
greift auch zB. google maps api (com/google/android/gms) oder in app billing (com/android/iab/v3) an, collateral schaden
one Pattern
...
einfach auf alles was in com/android ist
...
one pattern, used on both, similar like pattern N4
