...
Since the \textit{Kiwi} library is injected by Amazon and cannot be customized by the developer, only one pattern is necessary.
...
Similiar to the Amazon's \textit{Kiwi} library, Samsung's Zirconia library cannot be modified as well.
...
Unlike Amazon's \textit{Kiwi} \gls{drm}, Zirconia is not obfuscated and thus better to understand.
