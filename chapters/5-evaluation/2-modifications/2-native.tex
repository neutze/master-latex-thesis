\subsection{Native Implementation} \label{subsection:evaluation-modifications-dynamic}
%START TEXT INPUT
This is my real text! Rest might be copied or not be checked!
%START TEXT INPUT

at first a good protection against luckypatcher since the automatic patching discussed in Section~\ref{section:luckypatcher} does not work for the app any longer, but not protection of luckypatcher because it supports custom patching
